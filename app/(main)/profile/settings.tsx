...
export default function ProfileScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-brand-50" edges={['top']}>
      ...
      <View className="flex-row items-center px-4 py-3 bg-brand-50 border-b border-brand-100">
        <TouchableOpacity onPress={() => router.back()} className="mr-3 p-1">
          <Feather name="arrow-left" size={24} color={THEME_COLORS.primary[900]} />
        </TouchableOpacity>
        <Text className="text-lg font-bold text-brand-900">Thông tin cá nhân và cài đặt</Text>
      </View>
